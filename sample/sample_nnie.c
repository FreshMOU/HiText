...
{
    HI_CHAR *pcSrcFile = "./0_28x28.y";
    HI_CHAR *pcModelName = "./lenet.wk";
    HI_U32 u32PicNum = 1;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_SSD_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    pstSoftWareParam->au32ConvHeight[0]  = 48; 
    pstSoftWareParam->au32ConvWidth[0]   = 48;
    pstSoftWareParam->au32ConvChannel[0] = 240;
    pstSoftWareParam->au32ConvHeight[1]  = 48; 
    pstSoftWareParam->au32ConvWidth[1]   = 48;
    pstSoftWareParam->au32ConvChannel[1] = 40;
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_FASTERRCNN_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    else if(SAMPLE_SVP_NNIE_PVANET_FASTER_RCNN == s_enNetType)
    {
        pstSoftWareParam->u32ClassNum = 21;
	 ...
	 pstSoftWareParam->au32Ratios[3] = (HI_S32)(0.1 * SAMPLE_SVP_QUANT_BASE);
    ...
    {
        if(SAMPLE_SVP_NNIE_RES18_FASTER_RCNN == s_enNetType || SAMPLE_SVP_NNIE_RES34_FASTER_RCNN == s_enNetType)
        {
    ...
    if(SAMPLE_SVP_NNIE_PVANET_FASTER_RCNN != s_enNetType)
    {
        pstSoftWareParam->u32NumBeforeNms = 6000;
	 pstSoftWareParam->u32MaxRoiNum = 300;
    }
    else
    {
...
/*function : show Pvanet sample*/
void SAMPLE_SVP_NNIE_Pvanet(void)
{
    HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/horse_dog_car_person.bgr";
   ...
   /*NNIE process 1-th seg, the input conv data comes from 0-th seg's 0-th report node,
    ...
    /*print result, FasterRcnn pvanet has 5 classes*/
    /*class 0: background, class 1: horse, class 2: dog, class 3: car, class 4: person*/
